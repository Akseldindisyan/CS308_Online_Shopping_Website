...
export const products: Product[] = [
  {
    ...
    description: "A premium 14-inch laptop built for multitasking, sharp visuals, and all-day productivity.",
  ...
  },
  {
    ...
    description: "A fast flagship phone with a vivid camera system, smooth scrolling, and reliable battery life.",
  ...
  },
  {
    ...
    description: "Lightweight and portable, ideal for note taking, streaming, and work on the go.",
  ...
  },
  {
    ...
    description: "Noise-canceling headphones tuned for immersive sound, comfort, and crystal-clear calls.",
  ...
  },
  {
    ...
    description: "Responsive mechanical switches with customizable RGB lighting for gaming and productivity.",
  ...
  },
  {
    ...
    description: "Expand your workspace with extra ports, fast data transfer, and compact desk-friendly design.",
  ...
  },
  {
    ...
    description: "A vibrant monitor designed for smooth gameplay, creative work, and immersive viewing.",
  ...
  },
  {
    ...
    description: "Charge your phone, earbuds, and watch in one clean setup with quick wireless charging.",
